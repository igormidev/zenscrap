...
void main() {
  test('Is correct schema', () async {
    final schemaFile = File('/Users/igor/PersonalProjects/zenscrap/claude_code_sdk/ai_generated_files/schema_response_id-cpbD.json');
    if (!await schemaFile.exists()) {
      throw Exception('Schema file does not exist at " /Users/igor/PersonalProjects/zenscrap/claude_code_sdk/ai_generated_files/schema_response_id-cpbD.json " - AI did not write any JSON output to the file');
    }
    final schemaContent = await schemaFile.readAsString();
    if (schemaContent.trim().isEmpty) {
      throw Exception('Schema file is empty at " /Users/igor/PersonalProjects/zenscrap/claude_code_sdk/ai_generated_files/schema_response_id-cpbD.json " - AI did not write any JSON output to the file');
    }
    ...
    'presidents': SchemaProperty.array(
      items: SchemaProperty.structuredObject(
        properties: {
          ...
          'termStartYear': SchemaProperty.text(
            nullable: false,
          ),
        },
        nullable: false,
