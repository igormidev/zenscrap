...
--
-- Class IpValidationCache as table ip_validation_cache
--
...
--
-- Class PendingSessionCommit as table pending_session_commit
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('zenscrap', '20260216132158553', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260216132158553', "timestamp" = now();
