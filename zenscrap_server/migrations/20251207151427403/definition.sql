...
CREATE TABLE "scrappable" (
    ...
    "lastAutoFixAttemptAt" timestamp without time zone,
    "autoFixInProgress" boolean NOT NULL DEFAULT false,
    "autoFixAttemptCount" bigint NOT NULL DEFAULT 0
);
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('zenscrap', '20251207151427403', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20251207151427403', "timestamp" = now();
