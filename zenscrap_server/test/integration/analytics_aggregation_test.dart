...
void main() {
  withServerpod('Given analytics aggregation optimization',
    ...
    test(
      ...
      expect(counts, contains(2), reason: 'Current hour should have 2 records');
      expect(counts, contains(1), reason: 'Previous hour should have 1 record');
    });
    ...
    test('interval calculation should produce correct non-overlapping time ranges',
        () async {
      ...
      final totalSpan = intervals[0]['end']!.difference(intervals[11]['start']!);
