...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1353: (x0,x1) => x0.getAttribute(x1),
      _1354: (x0,x1) => x0.createElement(x1),
      _1355: (x0,x1,x2) => x0.setAttribute(x1,x2),
      ...
      _1397: (x0,x1) => x0.querySelectorAll(x1),
      _1398: (x0,x1) => x0.removeChild(x1),
      _1399: (x0,x1,x2) => x0.insertAdjacentHTML(x1,x2),
      _1409: (x0,x1) => x0.item(x1),
      _1410: x0 => x0.decode(),
      _1411: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1412: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      ...
      _1415: x0 => x0.send(),
      _1416: () => new XMLHttpRequest(),
      _1417: (x0,x1) => x0.getItem(x1),
      _1418: (x0,x1) => x0.removeItem(x1),
      _1419: (x0,x1,x2) => x0.setItem(x1,x2),
      _1420: x0 => ({type: x0}),
      _1421: (x0,x1) => new Blob(x0,x1),
      ...
      _1435: (x0,x1,x2,x3) => x0.identify(x1,x2,x3),
      _1436: (x0,x1,x2) => x0.capture(x1,x2),
      _1437: (x0,x1) => x0.alias(x1),
      _1438: x0 => x0.get_distinct_id(),
      _1439: x0 => x0.reset(),
      _1440: (x0,x1) => x0.debug(x1),
      _1441: (x0,x1) => x0.isFeatureEnabled(x1),
      _1442: (x0,x1,x2,x3) => x0.group(x1,x2,x3),
      _1443: x0 => x0.reloadFeatureFlags(),
      _1444: x0 => x0.opt_in_capturing(),
      _1445: x0 => x0.opt_out_capturing(),
      _1446: x0 => x0.has_opted_out_capturing(),
      _1447: (x0,x1) => x0.getFeatureFlag(x1),
      _1448: (x0,x1) => x0.getFeatureFlagPayload(x1),
      _1449: (x0,x1) => x0.register(x1),
      _1450: (x0,x1) => x0.unregister(x1),
      _1451: x0 => x0.get_session_id(),
      _1452: () => globalThis.window.posthog,
      _1456: Date.now,
      ...
      _1662: (x0,x1) => new WebSocket(x0,x1),
      _1663: (x0,x1) => x0.send(x1),
      _1664: (x0,x1,x2) => x0.close(x1,x2),
      _1666: x0 => x0.close(),
      _1669: (x0,x1) => x0.log(x1),
      _1670: () => new AbortController(),
      _1671: x0 => x0.abort(),
      ...
      _1677: x0 => x0.getReader(),
      _1678: x0 => x0.cancel(),
      _1679: x0 => x0.read(),
      _1680: x0 => x0.trustedTypes,
      _1681: (x0,x1) => { x0.src = x1 },
      _1682: (x0,x1) => x0.createScriptURL(x1),
      _1683: x0 => x0.nonce,
      _1684: (x0,x1) => x0.debug(x1),
      _1685: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1685(f,arguments.length,x0) }),
      _1686: x0 => ({createScriptURL: x0}),
      _1687: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1688: (x0,x1) => x0.querySelectorAll(x1),
      _1689: (x0,x1) => x0.key(x1),
      _1910: x0 => x0.random(),
      _1911: (x0,x1) => x0.getRandomValues(x1),
      _1912: () => globalThis.crypto,
      _1913: () => globalThis.Math,
      _1922: Function.prototype.call.bind(Number.prototype.toString),
      _1923: Function.prototype.call.bind(BigInt.prototype.toString),
      _1924: Function.prototype.call.bind(Number.prototype.toString),
      _1925: (d, digits) => d.toFixed(digits),
      _1939: () => globalThis.document,
      _1945: (x0,x1) => { x0.height = x1 },
      _1947: (x0,x1) => { x0.width = x1 },
      _1956: x0 => x0.style,
      _1959: x0 => x0.src,
      _1960: (x0,x1) => { x0.src = x1 },
      _1961: x0 => x0.naturalWidth,
      _1962: x0 => x0.naturalHeight,
      _1978: x0 => x0.status,
      _1979: (x0,x1) => { x0.responseType = x1 },
      _1981: x0 => x0.response,
      _2058: x0 => { globalThis.onGoogleLibraryLoad = x0 },
      _2059: f => finalizeWrapper(f, function() { return dartInstance.exports._2059(f,arguments.length) }),
      _2097: x0 => x0.readyState,
      _2099: (x0,x1) => { x0.timeout = x1 },
      _2101: (x0,x1) => { x0.withCredentials = x1 },
      _2102: x0 => x0.upload,
      _2103: x0 => x0.responseURL,
      _2104: x0 => x0.status,
      _2105: x0 => x0.statusText,
      _2107: (x0,x1) => { x0.responseType = x1 },
      _2108: x0 => x0.response,
      _2120: x0 => x0.loaded,
      _2121: x0 => x0.total,
      _2168: (x0,x1) => { x0.draggable = x1 },
      _2184: x0 => x0.style,
      _2383: (x0,x1) => { x0.nonce = x1 },
      _3113: (x0,x1) => { x0.accept = x1 },
      _3127: x0 => x0.files,
      _3153: (x0,x1) => { x0.multiple = x1 },
      _3171: (x0,x1) => { x0.type = x1 },
      _3421: (x0,x1) => { x0.src = x1 },
      _3427: (x0,x1) => { x0.async = x1 },
      _3429: (x0,x1) => { x0.defer = x1 },
      _3889: () => globalThis.window,
      _3929: x0 => x0.document,
      _3943: x0 => x0.closed,
      _3951: x0 => x0.navigator,
      _4213: x0 => x0.trustedTypes,
      _4215: x0 => x0.localStorage,
      _4338: x0 => x0.userAgent,
      _4389: x0 => x0.data,
      _4546: x0 => x0.length,
      _4763: x0 => x0.readyState,
      _4772: x0 => x0.protocol,
      ...
      _6637: x0 => x0.body,
      _6639: x0 => x0.head,
      _6966: (x0,x1) => { x0.id = x1 },
      _6993: x0 => x0.children,
      _8312: x0 => x0.value,
      _8314: x0 => x0.done,
      _8494: x0 => x0.size,
      _8495: x0 => x0.type,
      ...
      _9014: x0 => x0.headers,
      _9015: x0 => x0.body,
      _11419: (x0,x1) => { x0.display = x1 },
      _12641: x0 => x0.name,
      _13358: () => globalThis.console,
