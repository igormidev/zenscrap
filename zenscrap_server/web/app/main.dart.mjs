...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1392: (x0,x1) => x0.querySelectorAll(x1),
      _1393: (x0,x1) => x0.removeChild(x1),
      _1394: (x0,x1,x2) => x0.insertAdjacentHTML(x1,x2),
      _1395: x0 => x0.disconnect(),
      _1396: x0 => x0.disconnect(),
      _1397: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1397(f,arguments.length,x0,x1) }),
      _1398: x0 => new ResizeObserver(x0),
      _1399: (x0,x1) => x0.observe(x1),
      _1400: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1400(f,arguments.length,x0,x1) }),
      _1401: x0 => new MutationObserver(x0),
      _1402: x0 => ({childList: x0}),
      _1403: (x0,x1,x2) => x0.observe(x1,x2),
      _1404: (x0,x1) => x0.item(x1),
      _1405: (x0,x1) => x0.querySelector(x1),
      _1406: x0 => x0.decode(),
      ...
      _1413: (x0,x1) => x0.getItem(x1),
      _1414: (x0,x1) => x0.removeItem(x1),
      _1415: (x0,x1,x2) => x0.setItem(x1,x2),
      _1416: (x0,x1) => x0.key(x1),
      _1417: (x0,x1,x2,x3,x4,x5,x6,x7) => x0.unwrapKey(x1,x2,x3,x4,x5,x6,x7),
      _1418: (x0,x1,x2,x3,x4,x5) => x0.importKey(x1,x2,x3,x4,x5),
      _1419: (x0,x1,x2,x3) => x0.generateKey(x1,x2,x3),
      _1420: (x0,x1,x2,x3,x4) => x0.wrapKey(x1,x2,x3,x4),
      _1421: (x0,x1,x2) => x0.exportKey(x1,x2),
      _1422: (x0,x1) => x0.getRandomValues(x1),
      _1423: (x0,x1,x2,x3) => x0.encrypt(x1,x2,x3),
      _1424: (x0,x1,x2,x3) => x0.decrypt(x1,x2,x3),
      _1425: () => globalThis.removeSplashFromWeb(),
      _1426: (x0,x1,x2,x3) => x0.identify(x1,x2,x3),
      _1427: (x0,x1,x2,x3) => x0.capture(x1,x2,x3),
      _1428: (x0,x1) => x0.alias(x1),
      _1429: x0 => x0.get_distinct_id(),
      _1430: x0 => x0.reset(),
      _1431: (x0,x1) => x0.debug(x1),
      _1432: (x0,x1) => x0.isFeatureEnabled(x1),
      _1433: (x0,x1,x2,x3) => x0.group(x1,x2,x3),
      _1434: x0 => x0.reloadFeatureFlags(),
      _1435: x0 => x0.opt_in_capturing(),
      _1436: x0 => x0.opt_out_capturing(),
      _1437: x0 => x0.has_opted_out_capturing(),
      _1438: (x0,x1) => x0.getFeatureFlag(x1),
      _1439: (x0,x1) => x0.getFeatureFlagPayload(x1),
      _1440: (x0,x1) => x0.register(x1),
      _1441: (x0,x1) => x0.unregister(x1),
      _1442: x0 => x0.get_session_id(),
      _1443: () => globalThis.window.posthog,
      _1446: (x0,x1) => x0.initialize(x1),
      _1447: (x0,x1) => x0.initTokenClient(x1),
      _1450: x0 => x0.disableAutoSelect(),
      _1454: Date.now,
      _1456: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1457: s => {
      ...
      _1481: (o, p, r) => o.replaceAll(p, () => r),
      _1482: (o, p, r) => o.replace(p, () => r),
      _1483: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1484: s => s.toUpperCase(),
      _1485: s => s.trim(),
      _1486: s => s.trimLeft(),
      _1487: s => s.trimRight(),
      _1488: (string, times) => string.repeat(times),
      _1489: Function.prototype.call.bind(String.prototype.indexOf),
      _1490: (s, p, i) => s.lastIndexOf(p, i),
      _1491: (string, token) => string.split(token),
      _1492: Object.is,
      _1493: o => o instanceof Array,
      _1494: (a, i) => a.push(i),
      _1498: a => a.pop(),
      _1499: (a, i) => a.splice(i, 1),
      _1500: (a, s) => a.join(s),
      _1501: (a, s, e) => a.slice(s, e),
      _1503: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1504: a => a.length,
      _1506: (a, i) => a[i],
      _1507: (a, i, v) => a[i] = v,
      _1508: (a, t) => a.concat(t),
      _1509: o => {
      ...
      _1510: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1512: o => o instanceof Uint8Array,
      _1513: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1514: o => o instanceof Int8Array,
      _1515: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1516: o => o instanceof Uint8ClampedArray,
      _1517: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1518: o => o instanceof Uint16Array,
      _1519: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1520: o => o instanceof Int16Array,
      _1521: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1522: o => o instanceof Uint32Array,
      _1523: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1524: o => o instanceof Int32Array,
      _1525: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1527: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1528: o => o instanceof Float32Array,
      _1529: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1530: o => o instanceof Float64Array,
      _1531: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1532: (t, s) => t.set(s),
      _1533: l => new DataView(new ArrayBuffer(l)),
      _1534: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1536: o => o.buffer,
      _1537: o => o.byteOffset,
      _1538: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1539: (b, o) => new DataView(b, o),
      _1540: (b, o, l) => new DataView(b, o, l),
      _1541: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1542: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1543: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1544: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1545: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1546: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1547: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1548: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1549: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1550: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1551: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1552: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1555: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1556: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1557: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1558: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1559: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1560: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1573: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1574: (handle) => clearTimeout(handle),
      _1575: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1576: (handle) => clearInterval(handle),
      _1577: (c) =>
      ...
      _1580: (x0,x1) => x0.exec(x1),
      _1581: (x0,x1) => x0.test(x1),
      _1582: x0 => x0.pop(),
      _1584: o => o === undefined,
      _1586: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1588: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1589: o => o instanceof RegExp,
      _1590: (l, r) => l === r,
      _1591: o => o,
      _1592: o => o,
      _1593: o => o,
      ...
      _1595: o => o.length,
      _1597: (o, i) => o[i],
      _1598: f => f.dartFunction,
      _1599: () => ({}),
      _1600: () => [],
      _1602: () => globalThis,
      _1603: (constructor, args) => {
      ...
      _1605: (o, p) => o[p],
      _1606: (o, p, v) => o[p] = v,
      _1607: (o, m, a) => o[m].apply(o, a),
      _1609: o => String(o),
      _1610: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
      ...
      _1614: o => [o],
      _1615: (o0, o1) => [o0, o1],
      _1616: (o0, o1, o2) => [o0, o1, o2],
      _1617: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _1639: (o, p) => p in o,
      _1640: (o, p) => o[p],
      _1644: () => new XMLHttpRequest(),
      _1647: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      _1648: (x0,x1) => x0.send(x1),
      _1649: x0 => x0.send(),
      ...
      _1657: (x0,x1,x2) => x0.open(x1,x2),
      _1658: x0 => x0.abort(),
      _1659: x0 => x0.getAllResponseHeaders(),
      _1660: (x0,x1) => new WebSocket(x0,x1),
      _1661: (x0,x1) => x0.send(x1),
      _1662: (x0,x1,x2) => x0.close(x1,x2),
      _1664: x0 => x0.close(),
      _1669: (x0,x1) => x0.appendChild(x1),
      _1675: (x0,x1) => x0.log(x1),
      _1676: () => new AbortController(),
      _1677: x0 => x0.abort(),
      ...
      _1681: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1681(f,arguments.length,x0,x1,x2) }),
      _1682: (x0,x1) => x0.forEach(x1),
      _1683: x0 => x0.getReader(),
      _1684: x0 => x0.cancel(),
      _1685: x0 => x0.read(),
      _1686: x0 => x0.trustedTypes,
      _1687: (x0,x1) => { x0.src = x1 },
      _1688: (x0,x1) => x0.createScriptURL(x1),
      _1689: x0 => x0.nonce,
      _1690: (x0,x1) => x0.debug(x1),
      _1691: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1691(f,arguments.length,x0) }),
      _1692: x0 => ({createScriptURL: x0}),
      _1693: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1694: (x0,x1) => x0.querySelectorAll(x1),
      _1695: x0 => x0.random(),
      ...
      _1708: Function.prototype.call.bind(BigInt.prototype.toString),
      ...
      _1741: x0 => x0.style,
      _1744: x0 => x0.src,
      _1745: (x0,x1) => { x0.src = x1 },
      _1746: x0 => x0.naturalWidth,
      _1747: x0 => x0.naturalHeight,
      _1763: x0 => x0.status,
      _1764: (x0,x1) => { x0.responseType = x1 },
      _1766: x0 => x0.response,
      _1767: () => globalThis.google.accounts.oauth2,
      _1768: (x0,x1,x2) => x0.hasGrantedAllScopes(x1,x2),
      ...
      _1783: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10) => ({client_id: x0,callback: x1,scope: x2,include_granted_scopes: x3,prompt: x4,enable_granular_consent: x5,enable_serial_consent: x6,login_hint: x7,hd: x8,state: x9,error_callback: x10}),
      _1784: x0 => x0.requestAccessToken(),
      _1787: x0 => x0.access_token,
      _1788: x0 => x0.expires_in,
      _1794: x0 => x0.error,
      _1795: x0 => x0.error_description,
      _1797: x0 => x0.type,
      _1798: x0 => x0.message,
      _1802: () => globalThis.google.accounts.id,
      _1805: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1805(f,arguments.length,x0) }),
      _1806: (x0,x1) => x0.prompt(x1),
      _1807: (x0,x1) => x0.renderButton(x1),
      _1808: (x0,x1,x2) => x0.renderButton(x1,x2),
      ...
      _1823: x0 => x0.isSkippedMoment(),
      _1824: x0 => x0.isDismissedMoment(),
      _1828: x0 => x0.getDismissedReason(),
      _1830: x0 => x0.error,
      _1832: x0 => x0.credential,
      _1835: (x0,x1,x2,x3,x4,x5,x6,x7,x8) => ({type: x0,theme: x1,size: x2,text: x3,shape: x4,logo_alignment: x5,width: x6,locale: x7,click_listener: x8}),
      _1843: x0 => { globalThis.onGoogleLibraryLoad = x0 },
      _1844: f => finalizeWrapper(f, function() { return dartInstance.exports._1844(f,arguments.length) }),
      _1882: x0 => x0.readyState,
      _1884: (x0,x1) => { x0.timeout = x1 },
      _1886: (x0,x1) => { x0.withCredentials = x1 },
      _1887: x0 => x0.upload,
      _1888: x0 => x0.responseURL,
      _1889: x0 => x0.status,
      _1890: x0 => x0.statusText,
      _1892: (x0,x1) => { x0.responseType = x1 },
      _1893: x0 => x0.response,
      _1905: x0 => x0.loaded,
      _1906: x0 => x0.total,
      _2168: (x0,x1) => { x0.nonce = x1 },
      _3206: (x0,x1) => { x0.src = x1 },
      _3212: (x0,x1) => { x0.async = x1 },
      _3214: (x0,x1) => { x0.defer = x1 },
      _3675: () => globalThis.window,
      _3715: x0 => x0.document,
      _3737: x0 => x0.navigator,
      _3992: x0 => x0.isSecureContext,
      _3995: x0 => x0.crypto,
      _3999: x0 => x0.trustedTypes,
      _4000: x0 => x0.sessionStorage,
      _4001: x0 => x0.localStorage,
      _4124: x0 => x0.userAgent,
      _4175: x0 => x0.data,
      _4332: x0 => x0.length,
      _4549: x0 => x0.readyState,
      _4558: x0 => x0.protocol,
      _4562: (x0,x1) => { x0.binaryType = x1 },
      _4565: x0 => x0.code,
      _4566: x0 => x0.reason,
      _6274: x0 => x0.signal,
      _6283: x0 => x0.length,
      _6304: x0 => x0.addedNodes,
      _6325: x0 => x0.baseURI,
      _6342: () => globalThis.document,
      _6423: x0 => x0.body,
      _6425: x0 => x0.head,
      _6754: (x0,x1) => { x0.id = x1 },
      _8100: x0 => x0.value,
      _8102: x0 => x0.done,
      _8799: x0 => x0.url,
      _8801: x0 => x0.status,
      _8803: x0 => x0.statusText,
      _8804: x0 => x0.headers,
      _8805: x0 => x0.body,
      _9164: x0 => x0.contentRect,
      _12431: x0 => x0.name,
      _12435: x0 => x0.subtle,
      _12755: x0 => x0.width,
      _12756: x0 => x0.height,
      _13140: () => globalThis.console,
