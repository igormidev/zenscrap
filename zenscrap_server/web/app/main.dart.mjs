...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1347: x0 => x0.remove(),
      _1348: (x0,x1) => x0.removeItem(x1),
      _1349: (x0,x1) => x0.getItem(x1),
      _1351: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1352: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1353: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _1355: (x0,x1) => x0.getAttribute(x1),
      _1359: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1395: (x0,x1) => x0.querySelectorAll(x1),
      _1396: (x0,x1) => x0.removeChild(x1),
      _1397: (x0,x1,x2) => x0.insertAdjacentHTML(x1,x2),
      _1398: x0 => x0.disconnect(),
      _1399: x0 => x0.disconnect(),
      _1400: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1400(f,arguments.length,x0,x1) }),
      _1401: x0 => new ResizeObserver(x0),
      _1402: (x0,x1) => x0.observe(x1),
      _1403: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1403(f,arguments.length,x0,x1) }),
      _1404: x0 => new MutationObserver(x0),
      _1405: x0 => ({childList: x0}),
      _1406: (x0,x1,x2) => x0.observe(x1,x2),
      ...
      _1417: (x0,x1) => x0.key(x1),
      _1418: (x0,x1,x2,x3,x4,x5,x6,x7) => x0.unwrapKey(x1,x2,x3,x4,x5,x6,x7),
      _1419: (x0,x1,x2,x3,x4,x5) => x0.importKey(x1,x2,x3,x4,x5),
      _1420: (x0,x1,x2,x3) => x0.generateKey(x1,x2,x3),
      _1421: (x0,x1,x2,x3,x4) => x0.wrapKey(x1,x2,x3,x4),
      _1422: (x0,x1,x2) => x0.exportKey(x1,x2),
      _1423: (x0,x1) => x0.getRandomValues(x1),
      _1424: (x0,x1,x2,x3) => x0.encrypt(x1,x2,x3),
      _1425: (x0,x1,x2,x3) => x0.decrypt(x1,x2,x3),
      _1426: () => globalThis.removeSplashFromWeb(),
      _1427: (x0,x1,x2,x3) => x0.identify(x1,x2,x3),
      _1428: (x0,x1,x2,x3) => x0.capture(x1,x2,x3),
      _1429: (x0,x1) => x0.alias(x1),
      _1430: x0 => x0.get_distinct_id(),
      _1431: x0 => x0.reset(),
      _1432: (x0,x1) => x0.debug(x1),
      _1433: (x0,x1) => x0.isFeatureEnabled(x1),
      _1434: (x0,x1,x2,x3) => x0.group(x1,x2,x3),
      _1435: x0 => x0.reloadFeatureFlags(),
      _1436: x0 => x0.opt_in_capturing(),
      _1437: x0 => x0.opt_out_capturing(),
      _1438: x0 => x0.has_opted_out_capturing(),
      _1439: (x0,x1) => x0.getFeatureFlag(x1),
      _1440: (x0,x1) => x0.getFeatureFlagPayload(x1),
      _1441: (x0,x1) => x0.register(x1),
      _1442: (x0,x1) => x0.unregister(x1),
      _1443: x0 => x0.get_session_id(),
      _1444: () => globalThis.window.posthog,
      _1447: (x0,x1) => x0.initialize(x1),
      _1448: (x0,x1) => x0.initTokenClient(x1),
      _1451: x0 => x0.disableAutoSelect(),
      _1455: Date.now,
      ...
      _1460: () => typeof dartUseDateNowForTicks !== "undefined",
      _1461: () => 1000 * performance.now(),
      _1462: () => Date.now(),
      _1463: () => {
      ...
      _1465: () => new WeakMap(),
      _1466: (map, o) => map.get(o),
      _1467: (map, o, v) => map.set(o, v),
      _1468: x0 => new WeakRef(x0),
      _1469: x0 => x0.deref(),
      _1476: () => globalThis.WeakRef,
      _1480: s => JSON.stringify(s),
      _1481: s => printToConsole(s),
      ...
      _1493: Object.is,
      _1494: o => o instanceof Array,
      _1495: (a, i) => a.push(i),
      _1499: a => a.pop(),
      _1500: (a, i) => a.splice(i, 1),
      _1501: (a, s) => a.join(s),
      _1502: (a, s, e) => a.slice(s, e),
      _1504: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1505: a => a.length,
      _1507: (a, i) => a[i],
      _1508: (a, i, v) => a[i] = v,
      _1509: (a, t) => a.concat(t),
      _1510: o => {
      ...
      _1511: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1513: o => o instanceof Uint8Array,
      _1514: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1515: o => o instanceof Int8Array,
      _1516: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1517: o => o instanceof Uint8ClampedArray,
      _1518: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1519: o => o instanceof Uint16Array,
      _1520: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1521: o => o instanceof Int16Array,
      _1522: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1523: o => o instanceof Uint32Array,
      _1524: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1525: o => o instanceof Int32Array,
      _1526: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1528: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1529: o => o instanceof Float32Array,
      _1530: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1531: o => o instanceof Float64Array,
      _1532: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1533: (t, s) => t.set(s),
      _1534: l => new DataView(new ArrayBuffer(l)),
      _1535: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1537: o => o.buffer,
      _1538: o => o.byteOffset,
      _1539: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1540: (b, o) => new DataView(b, o),
      _1541: (b, o, l) => new DataView(b, o, l),
      _1542: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1543: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1544: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1545: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1546: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1547: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1548: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1549: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1550: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1551: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1552: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1553: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1556: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1557: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1558: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1559: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1560: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1561: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1574: (ms, c) =>
      ...
      _1633: x0 => x0.groups,
      _1634: x0 => x0.flags,
      _1635: x0 => x0.multiline,
      _1636: x0 => x0.ignoreCase,
      _1637: x0 => x0.unicode,
      _1638: x0 => x0.dotAll,
      _1639: (x0,x1) => { x0.lastIndex = x1 },
      _1640: (o, p) => p in o,
      _1641: (o, p) => o[p],
      ...
      _1658: (x0,x1,x2) => x0.open(x1,x2),
      _1659: x0 => x0.abort(),
      _1660: x0 => x0.getAllResponseHeaders(),
      _1661: (x0,x1) => new WebSocket(x0,x1),
      _1662: (x0,x1) => x0.send(x1),
      _1663: (x0,x1,x2) => x0.close(x1,x2),
      _1665: x0 => x0.close(),
      _1670: (x0,x1) => x0.appendChild(x1),
      ...
      _1682: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1682(f,arguments.length,x0,x1,x2) }),
      _1683: (x0,x1) => x0.forEach(x1),
      _1684: x0 => x0.getReader(),
      _1685: x0 => x0.cancel(),
      _1686: x0 => x0.read(),
      _1687: x0 => x0.trustedTypes,
      _1688: (x0,x1) => { x0.src = x1 },
      _1689: (x0,x1) => x0.createScriptURL(x1),
      _1690: x0 => x0.nonce,
      _1691: (x0,x1) => x0.debug(x1),
      _1692: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1692(f,arguments.length,x0) }),
      _1693: x0 => ({createScriptURL: x0}),
      _1694: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1695: (x0,x1) => x0.querySelectorAll(x1),
      _1696: x0 => x0.random(),
      _1697: (x0,x1) => x0.getRandomValues(x1),
      _1698: () => globalThis.crypto,
      _1699: () => globalThis.Math,
      _1708: Function.prototype.call.bind(Number.prototype.toString),
      _1709: Function.prototype.call.bind(BigInt.prototype.toString),
      _1710: Function.prototype.call.bind(Number.prototype.toString),
      _1711: (d, digits) => d.toFixed(digits),
      _1725: () => globalThis.document,
      _1731: (x0,x1) => { x0.height = x1 },
      _1733: (x0,x1) => { x0.width = x1 },
      _1742: x0 => x0.style,
      _1745: x0 => x0.src,
      _1746: (x0,x1) => { x0.src = x1 },
      _1747: x0 => x0.naturalWidth,
      _1748: x0 => x0.naturalHeight,
      _1764: x0 => x0.status,
      _1765: (x0,x1) => { x0.responseType = x1 },
      _1767: x0 => x0.response,
      _1768: () => globalThis.google.accounts.oauth2,
      _1769: (x0,x1,x2) => x0.hasGrantedAllScopes(x1,x2),
      ...
      _1784: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10) => ({client_id: x0,callback: x1,scope: x2,include_granted_scopes: x3,prompt: x4,enable_granular_consent: x5,enable_serial_consent: x6,login_hint: x7,hd: x8,state: x9,error_callback: x10}),
      _1785: x0 => x0.requestAccessToken(),
      _1788: x0 => x0.access_token,
      _1789: x0 => x0.expires_in,
      _1795: x0 => x0.error,
      _1796: x0 => x0.error_description,
      _1798: x0 => x0.type,
      _1799: x0 => x0.message,
      _1803: () => globalThis.google.accounts.id,
      _1806: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1806(f,arguments.length,x0) }),
      _1807: (x0,x1) => x0.prompt(x1),
      _1808: (x0,x1) => x0.renderButton(x1),
      _1809: (x0,x1,x2) => x0.renderButton(x1,x2),
      ...
      _1824: x0 => x0.isSkippedMoment(),
      _1825: x0 => x0.isDismissedMoment(),
      _1829: x0 => x0.getDismissedReason(),
      _1831: x0 => x0.error,
      _1833: x0 => x0.credential,
      _1836: (x0,x1,x2,x3,x4,x5,x6,x7,x8) => ({type: x0,theme: x1,size: x2,text: x3,shape: x4,logo_alignment: x5,width: x6,locale: x7,click_listener: x8}),
      _1844: x0 => { globalThis.onGoogleLibraryLoad = x0 },
      _1845: f => finalizeWrapper(f, function() { return dartInstance.exports._1845(f,arguments.length) }),
      _1883: x0 => x0.readyState,
      _1885: (x0,x1) => { x0.timeout = x1 },
      _1887: (x0,x1) => { x0.withCredentials = x1 },
      _1888: x0 => x0.upload,
      _1889: x0 => x0.responseURL,
      _1890: x0 => x0.status,
      _1891: x0 => x0.statusText,
      _1893: (x0,x1) => { x0.responseType = x1 },
      _1894: x0 => x0.response,
      _1906: x0 => x0.loaded,
      _1907: x0 => x0.total,
      _1970: x0 => x0.style,
      _2169: (x0,x1) => { x0.nonce = x1 },
      _2447: (x0,x1) => { x0.src = x1 },
      _3207: (x0,x1) => { x0.src = x1 },
      _3213: (x0,x1) => { x0.async = x1 },
      _3215: (x0,x1) => { x0.defer = x1 },
      _3676: () => globalThis.window,
      _3716: x0 => x0.document,
      _3738: x0 => x0.navigator,
      _3993: x0 => x0.isSecureContext,
      _3996: x0 => x0.crypto,
      _4000: x0 => x0.trustedTypes,
      _4001: x0 => x0.sessionStorage,
      _4002: x0 => x0.localStorage,
      _4125: x0 => x0.userAgent,
      _4176: x0 => x0.data,
      _4177: x0 => x0.origin,
      _4333: x0 => x0.length,
      _4550: x0 => x0.readyState,
      _4559: x0 => x0.protocol,
      _4563: (x0,x1) => { x0.binaryType = x1 },
      _4566: x0 => x0.code,
      _4567: x0 => x0.reason,
      _6275: x0 => x0.signal,
      _6284: x0 => x0.length,
      _6305: x0 => x0.addedNodes,
      _6326: x0 => x0.baseURI,
      _6343: () => globalThis.document,
      _6424: x0 => x0.body,
      _6426: x0 => x0.head,
