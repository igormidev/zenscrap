...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1349: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _1351: (x0,x1) => x0.getAttribute(x1),
      _1355: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1390: (x0,x1) => x0.querySelectorAll(x1),
      _1391: (x0,x1) => x0.removeChild(x1),
      _1392: (x0,x1,x2) => x0.insertAdjacentHTML(x1,x2),
      _1393: x0 => x0.disconnect(),
      _1394: x0 => x0.disconnect(),
      _1395: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1395(f,arguments.length,x0,x1) }),
      _1396: x0 => new ResizeObserver(x0),
      _1397: (x0,x1) => x0.observe(x1),
      _1398: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1398(f,arguments.length,x0,x1) }),
      _1399: x0 => new MutationObserver(x0),
      _1400: x0 => ({childList: x0}),
      _1401: (x0,x1,x2) => x0.observe(x1,x2),
      _1402: (x0,x1) => x0.item(x1),
      _1403: (x0,x1) => x0.querySelector(x1),
      _1404: x0 => x0.decode(),
      _1405: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1406: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      ...
      _1409: x0 => x0.send(),
      _1410: () => new XMLHttpRequest(),
      _1411: (x0,x1) => x0.getItem(x1),
      _1412: (x0,x1) => x0.removeItem(x1),
      _1413: (x0,x1,x2) => x0.setItem(x1,x2),
      _1414: (x0,x1) => x0.key(x1),
      _1415: (x0,x1,x2,x3,x4,x5,x6,x7) => x0.unwrapKey(x1,x2,x3,x4,x5,x6,x7),
      _1416: (x0,x1,x2,x3,x4,x5) => x0.importKey(x1,x2,x3,x4,x5),
      _1417: (x0,x1,x2,x3) => x0.generateKey(x1,x2,x3),
      _1418: (x0,x1,x2,x3,x4) => x0.wrapKey(x1,x2,x3,x4),
      _1419: (x0,x1,x2) => x0.exportKey(x1,x2),
      _1420: (x0,x1) => x0.getRandomValues(x1),
      _1421: (x0,x1,x2,x3) => x0.encrypt(x1,x2,x3),
      _1422: (x0,x1,x2,x3) => x0.decrypt(x1,x2,x3),
      _1423: () => globalThis.removeSplashFromWeb(),
      _1424: (x0,x1,x2,x3) => x0.identify(x1,x2,x3),
      _1425: (x0,x1,x2) => x0.capture(x1,x2),
      _1426: (x0,x1) => x0.alias(x1),
      _1427: x0 => x0.get_distinct_id(),
      _1428: x0 => x0.reset(),
      _1429: (x0,x1) => x0.debug(x1),
      _1430: (x0,x1) => x0.isFeatureEnabled(x1),
      _1431: (x0,x1,x2,x3) => x0.group(x1,x2,x3),
      _1432: x0 => x0.reloadFeatureFlags(),
      _1433: x0 => x0.opt_in_capturing(),
      _1434: x0 => x0.opt_out_capturing(),
      _1435: x0 => x0.has_opted_out_capturing(),
      _1436: (x0,x1) => x0.getFeatureFlag(x1),
      _1437: (x0,x1) => x0.getFeatureFlagPayload(x1),
      _1438: (x0,x1) => x0.register(x1),
      _1439: (x0,x1) => x0.unregister(x1),
      _1440: x0 => x0.get_session_id(),
      _1441: () => globalThis.window.posthog,
      _1443: (x0,x1) => x0.initialize(x1),
      _1444: (x0,x1) => x0.initTokenClient(x1),
      _1447: x0 => x0.disableAutoSelect(),
      _1451: Date.now,
      _1453: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1454: s => {
      ...
      _1456: () => typeof dartUseDateNowForTicks !== "undefined",
      _1457: () => 1000 * performance.now(),
      _1458: () => Date.now(),
      _1459: () => {
      ...
      _1461: () => new WeakMap(),
      _1462: (map, o) => map.get(o),
      _1463: (map, o, v) => map.set(o, v),
      _1464: x0 => new WeakRef(x0),
      _1465: x0 => x0.deref(),
      _1472: () => globalThis.WeakRef,
      _1476: s => JSON.stringify(s),
      _1477: s => printToConsole(s),
      _1478: (o, p, r) => o.replaceAll(p, () => r),
      _1479: (o, p, r) => o.replace(p, () => r),
      _1480: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1481: s => s.toUpperCase(),
      _1482: s => s.trim(),
      _1483: s => s.trimLeft(),
      _1484: s => s.trimRight(),
      _1485: (string, times) => string.repeat(times),
      _1486: Function.prototype.call.bind(String.prototype.indexOf),
      _1487: (s, p, i) => s.lastIndexOf(p, i),
      _1488: (string, token) => string.split(token),
      _1489: Object.is,
      _1490: o => o instanceof Array,
      _1491: (a, i) => a.push(i),
      _1495: a => a.pop(),
      _1496: (a, i) => a.splice(i, 1),
      _1497: (a, s) => a.join(s),
      _1498: (a, s, e) => a.slice(s, e),
      _1500: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1501: a => a.length,
      _1503: (a, i) => a[i],
      _1504: (a, i, v) => a[i] = v,
      _1505: (a, t) => a.concat(t),
      _1506: o => {
      ...
      _1507: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1509: o => o instanceof Uint8Array,
      _1510: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1511: o => o instanceof Int8Array,
      _1512: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1513: o => o instanceof Uint8ClampedArray,
      _1514: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1515: o => o instanceof Uint16Array,
      _1516: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1517: o => o instanceof Int16Array,
      _1518: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1519: o => o instanceof Uint32Array,
      _1520: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1521: o => o instanceof Int32Array,
      _1522: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1524: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1525: o => o instanceof Float32Array,
      _1526: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1527: o => o instanceof Float64Array,
      _1528: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1529: (t, s) => t.set(s),
      _1530: l => new DataView(new ArrayBuffer(l)),
      _1531: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1533: o => o.buffer,
      _1534: o => o.byteOffset,
      _1535: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1536: (b, o) => new DataView(b, o),
      _1537: (b, o, l) => new DataView(b, o, l),
      _1538: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1539: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1540: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1541: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1542: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1543: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1544: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1545: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1546: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1547: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1548: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1549: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1552: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1553: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1554: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1555: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1556: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1557: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1570: (ms, c) =>
      ...
      _1606: o => String(o),
      _1607: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
      _1608: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1608(f,arguments.length,x0) }),
      _1609: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1609(f,arguments.length,x0,x1) }),
      _1610: o => {
      ...
      _1660: x0 => x0.close(),
      _1665: (x0,x1) => x0.appendChild(x1),
      _1671: (x0,x1) => x0.log(x1),
      _1672: () => new AbortController(),
      _1673: x0 => x0.abort(),
      _1674: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1675: (x0,x1) => globalThis.fetch(x0,x1),
      _1676: (x0,x1) => x0.get(x1),
      _1677: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1677(f,arguments.length,x0,x1,x2) }),
      _1678: (x0,x1) => x0.forEach(x1),
      _1679: x0 => x0.getReader(),
      _1680: x0 => x0.cancel(),
      _1681: x0 => x0.read(),
      _1682: x0 => x0.trustedTypes,
      _1683: (x0,x1) => { x0.src = x1 },
      _1684: (x0,x1) => x0.createScriptURL(x1),
      _1685: x0 => x0.nonce,
      _1686: (x0,x1) => x0.debug(x1),
      _1687: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1687(f,arguments.length,x0) }),
      _1688: x0 => ({createScriptURL: x0}),
      _1689: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1690: (x0,x1) => x0.querySelectorAll(x1),
      _1691: x0 => x0.random(),
      _1692: (x0,x1) => x0.getRandomValues(x1),
      _1693: () => globalThis.crypto,
      ...
      _1720: () => globalThis.document,
      _1726: (x0,x1) => { x0.height = x1 },
      _1728: (x0,x1) => { x0.width = x1 },
      _1737: x0 => x0.style,
      _1740: x0 => x0.src,
      _1741: (x0,x1) => { x0.src = x1 },
      _1742: x0 => x0.naturalWidth,
      _1743: x0 => x0.naturalHeight,
      _1759: x0 => x0.status,
      _1760: (x0,x1) => { x0.responseType = x1 },
      _1762: x0 => x0.response,
      _1763: () => globalThis.google.accounts.oauth2,
      _1764: (x0,x1,x2) => x0.hasGrantedAllScopes(x1,x2),
      ...
      _1779: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10) => ({client_id: x0,callback: x1,scope: x2,include_granted_scopes: x3,prompt: x4,enable_granular_consent: x5,enable_serial_consent: x6,login_hint: x7,hd: x8,state: x9,error_callback: x10}),
      _1780: x0 => x0.requestAccessToken(),
      _1783: x0 => x0.access_token,
      _1784: x0 => x0.expires_in,
      _1790: x0 => x0.error,
      _1791: x0 => x0.error_description,
      _1793: x0 => x0.type,
      _1794: x0 => x0.message,
      _1798: () => globalThis.google.accounts.id,
      _1801: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1801(f,arguments.length,x0) }),
      _1802: (x0,x1) => x0.prompt(x1),
      _1803: (x0,x1) => x0.renderButton(x1),
      _1804: (x0,x1,x2) => x0.renderButton(x1,x2),
      ...
      _1819: x0 => x0.isSkippedMoment(),
      _1820: x0 => x0.isDismissedMoment(),
      _1824: x0 => x0.getDismissedReason(),
      _1826: x0 => x0.error,
      _1828: x0 => x0.credential,
      _1831: (x0,x1,x2,x3,x4,x5,x6,x7,x8) => ({type: x0,theme: x1,size: x2,text: x3,shape: x4,logo_alignment: x5,width: x6,locale: x7,click_listener: x8}),
      _1839: x0 => { globalThis.onGoogleLibraryLoad = x0 },
      _1840: f => finalizeWrapper(f, function() { return dartInstance.exports._1840(f,arguments.length) }),
      _1878: x0 => x0.readyState,
      _1880: (x0,x1) => { x0.timeout = x1 },
      _1882: (x0,x1) => { x0.withCredentials = x1 },
      _1883: x0 => x0.upload,
      _1884: x0 => x0.responseURL,
      _1885: x0 => x0.status,
      _1886: x0 => x0.statusText,
      _1888: (x0,x1) => { x0.responseType = x1 },
      _1889: x0 => x0.response,
      _1901: x0 => x0.loaded,
      _1902: x0 => x0.total,
      _2164: (x0,x1) => { x0.nonce = x1 },
      _3202: (x0,x1) => { x0.src = x1 },
      _3208: (x0,x1) => { x0.async = x1 },
      _3210: (x0,x1) => { x0.defer = x1 },
      _3671: () => globalThis.window,
      _3711: x0 => x0.document,
      _3733: x0 => x0.navigator,
      _3988: x0 => x0.isSecureContext,
      _3991: x0 => x0.crypto,
      _3995: x0 => x0.trustedTypes,
      _3996: x0 => x0.sessionStorage,
      _3997: x0 => x0.localStorage,
      _4120: x0 => x0.userAgent,
      _4171: x0 => x0.data,
      _4328: x0 => x0.length,
      _4545: x0 => x0.readyState,
      _4554: x0 => x0.protocol,
      _4558: (x0,x1) => { x0.binaryType = x1 },
      _4561: x0 => x0.code,
      _4562: x0 => x0.reason,
      _6270: x0 => x0.signal,
      _6279: x0 => x0.length,
      _6300: x0 => x0.addedNodes,
      _6321: x0 => x0.baseURI,
      _6338: () => globalThis.document,
      _6419: x0 => x0.body,
      _6421: x0 => x0.head,
      _6750: (x0,x1) => { x0.id = x1 },
      _8096: x0 => x0.value,
      _8098: x0 => x0.done,
      _8795: x0 => x0.url,
      _8797: x0 => x0.status,
      ...
      _8800: x0 => x0.headers,
      _8801: x0 => x0.body,
      _9160: x0 => x0.contentRect,
      _12427: x0 => x0.name,
      _12431: x0 => x0.subtle,
      _12751: x0 => x0.width,
      _12752: x0 => x0.height,
      _13136: () => globalThis.console,
