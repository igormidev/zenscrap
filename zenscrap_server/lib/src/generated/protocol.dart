...
import 'entities/account/account_api_key.dart' as _i22;
...
import 'entities/account/api_usage/api_credit_history/monthly_subscription_credit_deposit.dart'
    as _i27;
import 'entities/account/account_ai_usage.dart' as _i28;
import 'entities/account/api_usage/credit_usage.dart' as _i29;
import 'entities/account/credit_purchase_option.dart' as _i30;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i22.AccountApiKey) {
      return _i22.AccountApiKey.fromJson(data) as T;
    }
    ...
    if (t == _i28.AccountAIUsage) {
      return _i28.AccountAIUsage.fromJson(data) as T;
    }
    if (t == _i29.CreditUsage) {
      return _i29.CreditUsage.fromJson(data) as T;
    }
    if (t == _i30.CreditPurchaseOption) {
      return _i30.CreditPurchaseOption.fromJson(data) as T;
    }
    if (t == _i31.AiModel) {
    ...
    if (t == _i1.getType<_i22.AccountApiKey?>()) {
      return (data != null ? _i22.AccountApiKey.fromJson(data) : null) as T;
    }
    ...
    if (t == _i1.getType<_i28.AccountAIUsage?>()) {
      return (data != null ? _i28.AccountAIUsage.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i29.CreditUsage?>()) {
      return (data != null ? _i29.CreditUsage.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i30.CreditPurchaseOption?>()) {
      return (data != null ? _i30.CreditPurchaseOption.fromJson(data) : null)
          as T;
    }
    ...
    if (t == List<_i22.AccountApiKey>) {
      return (data as List)
          .map((e) => deserialize<_i22.AccountApiKey>(e))
          .toList() as T;
    }
    if (t == Map<int, int>) {
    ...
    if (t == _i1.getType<List<_i22.AccountApiKey>?>()) {
      return (data != null
          ? (data as List)
              .map((e) => deserialize<_i22.AccountApiKey>(e))
              .toList()
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is _i28.AccountAIUsage) {
      return 'AccountAIUsage';
    }
    if (data is _i29.CreditUsage) {
      return 'CreditUsage';
    }
    if (data is _i30.CreditPurchaseOption) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'AccountApiKey') {
      return deserialize<_i22.AccountApiKey>(data['data']);
    }
    ...
    if (dataClassName == 'AccountAIUsage') {
      return deserialize<_i28.AccountAIUsage>(data['data']);
    }
    if (dataClassName == 'CreditUsage') {
      return deserialize<_i29.CreditUsage>(data['data']);
    }
    if (dataClassName == 'CreditPurchaseOption') {
      return deserialize<_i30.CreditPurchaseOption>(data['data']);
    }
  ...
  _i1.Table? getTableForType(Type t) {
    ...
    switch (t) {
      ...
      case _i28.AccountAIUsage:
        return _i28.AccountAIUsage.t;
      case _i22.AccountApiKey:
        return _i22.AccountApiKey.t;
      ...
      case _i29.CreditUsage:
        return _i29.CreditUsage.t;
