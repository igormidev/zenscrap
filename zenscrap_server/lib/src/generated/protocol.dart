...
import 'entities/analytics/analytics_request_details.dart' as _i10;
import 'entities/analytics/analytics_time_scope.dart' as _i11;
import 'entities/analytics/paginated_scrappable_analytics.dart' as _i12;
import 'entities/analytics/paginated_scrappable_requests_analytics.dart'
    as _i13;
import 'entities/account/account.dart' as _i14;
import 'entities/analytics/scrappable_requests_analytics_item.dart' as _i15;
import 'entities/analytics/scrappable_usage_metrics.dart' as _i16;
import 'entities/api_key_response.dart' as _i17;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i10.AnalyticsRequestDetails) {
      return _i10.AnalyticsRequestDetails.fromJson(data) as T;
    }
    if (t == _i11.AnalyticsTimeScope) {
      return _i11.AnalyticsTimeScope.fromJson(data) as T;
    }
    if (t == _i12.PaginatedScrappableAnalytics) {
      return _i12.PaginatedScrappableAnalytics.fromJson(data) as T;
    }
    if (t == _i13.PaginatedScrappableRequestsAnalytics) {
      return _i13.PaginatedScrappableRequestsAnalytics.fromJson(data) as T;
    }
    if (t == _i14.AccountInfo) {
      return _i14.AccountInfo.fromJson(data) as T;
    }
    if (t == _i15.ScrappableRequestsAnalyticsItem) {
      return _i15.ScrappableRequestsAnalyticsItem.fromJson(data) as T;
    }
    if (t == _i16.ScrappableUsageMetrics) {
      return _i16.ScrappableUsageMetrics.fromJson(data) as T;
    }
    if (t == _i17.ApiKeyResponse) {
      return _i17.ApiKeyResponse.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i10.AnalyticsRequestDetails?>()) {
      return (data != null ? _i10.AnalyticsRequestDetails.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i11.AnalyticsTimeScope?>()) {
      return (data != null ? _i11.AnalyticsTimeScope.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i12.PaginatedScrappableAnalytics?>()) {
      return (data != null
          ? _i12.PaginatedScrappableAnalytics.fromJson(data)
          : null) as T;
    }
    if (t == _i1.getType<_i13.PaginatedScrappableRequestsAnalytics?>()) {
      return (data != null
          ? _i13.PaginatedScrappableRequestsAnalytics.fromJson(data)
          : null) as T;
    }
    if (t == _i1.getType<_i14.AccountInfo?>()) {
      return (data != null ? _i14.AccountInfo.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i15.ScrappableRequestsAnalyticsItem?>()) {
      return (data != null
          ? _i15.ScrappableRequestsAnalyticsItem.fromJson(data)
          : null) as T;
    }
    if (t == _i1.getType<_i16.ScrappableUsageMetrics?>()) {
      return (data != null ? _i16.ScrappableUsageMetrics.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i17.ApiKeyResponse?>()) {
      return (data != null ? _i17.ApiKeyResponse.fromJson(data) : null) as T;
    }
    ...
    if (t == List<_i15.ScrappableRequestsAnalyticsItem>) {
      return (data as List)
          .map((e) => deserialize<_i15.ScrappableRequestsAnalyticsItem>(e))
          .toList() as T;
    }
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is _i10.AnalyticsRequestDetails) {
      return 'AnalyticsRequestDetails';
    }
    if (data is _i11.AnalyticsTimeScope) {
      return 'AnalyticsTimeScope';
    }
    if (data is _i12.PaginatedScrappableAnalytics) {
      return 'PaginatedScrappableAnalytics';
    }
    if (data is _i13.PaginatedScrappableRequestsAnalytics) {
      return 'PaginatedScrappableRequestsAnalytics';
    }
    if (data is _i14.AccountInfo) {
      return 'AccountInfo';
    }
    if (data is _i15.ScrappableRequestsAnalyticsItem) {
      return 'ScrappableRequestsAnalyticsItem';
    }
    if (data is _i16.ScrappableUsageMetrics) {
      return 'ScrappableUsageMetrics';
    }
    if (data is _i17.ApiKeyResponse) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'AnalyticsRequestDetails') {
      return deserialize<_i10.AnalyticsRequestDetails>(data['data']);
    }
    if (dataClassName == 'AnalyticsTimeScope') {
      return deserialize<_i11.AnalyticsTimeScope>(data['data']);
    }
    if (dataClassName == 'PaginatedScrappableAnalytics') {
      return deserialize<_i12.PaginatedScrappableAnalytics>(data['data']);
    }
    if (dataClassName == 'PaginatedScrappableRequestsAnalytics') {
      return deserialize<_i13.PaginatedScrappableRequestsAnalytics>(
          data['data']);
    }
    if (dataClassName == 'AccountInfo') {
      return deserialize<_i14.AccountInfo>(data['data']);
    }
    if (dataClassName == 'ScrappableRequestsAnalyticsItem') {
      return deserialize<_i15.ScrappableRequestsAnalyticsItem>(data['data']);
    }
    if (dataClassName == 'ScrappableUsageMetrics') {
      return deserialize<_i16.ScrappableUsageMetrics>(data['data']);
    }
    if (dataClassName == 'ApiKeyResponse') {
      return deserialize<_i17.ApiKeyResponse>(data['data']);
    }
  ...
  _i1.Table? getTableForType(Type t) {
    ...
    switch (t) {
      case _i14.AccountInfo:
        return _i14.AccountInfo.t;
      ...
      case _i10.AnalyticsRequestDetails:
        return _i10.AnalyticsRequestDetails.t;
