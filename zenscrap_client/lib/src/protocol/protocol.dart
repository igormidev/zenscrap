...
import 'entities/account/account_api_key.dart' as _i20;
...
import 'entities/account/api_usage/api_credit_history/monthly_subscription_credit_deposit.dart'
    as _i25;
import 'entities/account/account_ai_usage.dart' as _i26;
import 'entities/account/api_usage/credit_usage.dart' as _i27;
import 'entities/account/credit_purchase_option.dart' as _i28;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i20.AccountApiKey) {
      return _i20.AccountApiKey.fromJson(data) as T;
    }
    ...
    if (t == _i26.AccountAIUsage) {
      return _i26.AccountAIUsage.fromJson(data) as T;
    }
    if (t == _i27.CreditUsage) {
      return _i27.CreditUsage.fromJson(data) as T;
    }
    if (t == _i28.CreditPurchaseOption) {
      return _i28.CreditPurchaseOption.fromJson(data) as T;
    }
    if (t == _i29.AiModel) {
    ...
    if (t == _i1.getType<_i20.AccountApiKey?>()) {
      return (data != null ? _i20.AccountApiKey.fromJson(data) : null) as T;
    }
    ...
    if (t == _i1.getType<_i26.AccountAIUsage?>()) {
      return (data != null ? _i26.AccountAIUsage.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i27.CreditUsage?>()) {
      return (data != null ? _i27.CreditUsage.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i28.CreditPurchaseOption?>()) {
      return (data != null ? _i28.CreditPurchaseOption.fromJson(data) : null)
          as T;
    }
    ...
    if (t == List<_i20.AccountApiKey>) {
      return (data as List)
          .map((e) => deserialize<_i20.AccountApiKey>(e))
          .toList() as T;
    }
    if (t == Map<int, int>) {
    ...
    if (t == _i1.getType<List<_i20.AccountApiKey>?>()) {
      return (data != null
          ? (data as List)
              .map((e) => deserialize<_i20.AccountApiKey>(e))
              .toList()
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is _i26.AccountAIUsage) {
      return 'AccountAIUsage';
    }
    if (data is _i27.CreditUsage) {
      return 'CreditUsage';
    }
    if (data is _i28.CreditPurchaseOption) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'AccountApiKey') {
      return deserialize<_i20.AccountApiKey>(data['data']);
    }
    ...
    if (dataClassName == 'AccountAIUsage') {
      return deserialize<_i26.AccountAIUsage>(data['data']);
    }
    if (dataClassName == 'CreditUsage') {
      return deserialize<_i27.CreditUsage>(data['data']);
    }
    if (dataClassName == 'CreditPurchaseOption') {
      return deserialize<_i28.CreditPurchaseOption>(data['data']);
    }
