...
import 'entities/scrappable/scrapping_bee_extract_logic.dart' as _i33;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i33.ScrappingBeeExtractLogic) {
      return _i33.ScrappingBeeExtractLogic.fromJson(data) as T;
    }
    if (t == _i34.UserPaginatedScrappableResponse) {
      return _i34.UserPaginatedScrappableResponse.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i33.ScrappingBeeExtractLogic?>()) {
      return (data != null
          ? _i33.ScrappingBeeExtractLogic.fromJson(data)
          : null) as T;
    }
    if (t == _i1.getType<_i34.UserPaginatedScrappableResponse?>()) {
      return (data != null
          ? _i34.UserPaginatedScrappableResponse.fromJson(data)
          : null) as T;
    }
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is _i33.ScrappingBeeExtractLogic) {
      return 'ScrappingBeeExtractLogic';
    }
    if (data is _i34.UserPaginatedScrappableResponse) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'ScrappingBeeExtractLogic') {
      return deserialize<_i33.ScrappingBeeExtractLogic>(data['data']);
    }
    if (dataClassName == 'UserPaginatedScrappableResponse') {
      return deserialize<_i34.UserPaginatedScrappableResponse>(data['data']);
    }
