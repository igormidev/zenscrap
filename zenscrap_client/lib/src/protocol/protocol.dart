...
import 'entities/analytics/scraapable_request_per_day.dart' as _i9;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i9.ScrappableRequestPerHour) {
      return _i9.ScrappableRequestPerHour.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i9.ScrappableRequestPerHour?>()) {
      return (data != null ? _i9.ScrappableRequestPerHour.fromJson(data) : null)
          as T;
    }
    ...
    if (t == List<_i9.ScrappableRequestPerHour>) {
      return (data as List)
          .map((e) => deserialize<_i9.ScrappableRequestPerHour>(e))
          .toList() as T;
    }
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is _i9.ScrappableRequestPerHour) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'ScrappableRequestPerHour') {
      return deserialize<_i9.ScrappableRequestPerHour>(data['data']);
    }
