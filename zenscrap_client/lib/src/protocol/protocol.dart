...
import 'entities/account/api_usage/account_api_usage.dart' as _i19;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i19.AccountApiUsage) {
      return _i19.AccountApiUsage.fromJson(data) as T;
    }
    ...
    if (t == _i32.MonthlySubscriptionCreditDeposit) {
      return _i32.MonthlySubscriptionCreditDeposit.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i19.AccountApiUsage?>()) {
      return (data != null ? _i19.AccountApiUsage.fromJson(data) : null) as T;
    }
    ...
    if (t == _i1.getType<_i32.MonthlySubscriptionCreditDeposit?>()) {
      return (data != null
          ? _i32.MonthlySubscriptionCreditDeposit.fromJson(data)
          : null) as T;
    }
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is _i19.AccountApiUsage) {
    ...
    if (data is _i32.MonthlySubscriptionCreditDeposit) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'AccountApiUsage') {
      return deserialize<_i19.AccountApiUsage>(data['data']);
    }
    ...
    if (dataClassName == 'MonthlySubscriptionCreditDeposit') {
      return deserialize<_i32.MonthlySubscriptionCreditDeposit>(data['data']);
    }
