...
class EndpointPrivateApiUsage extends _i1.EndpointRef {
  ...
  _i2.Future<List<_i8.AccountApiKey>> getActiveApiKeys() =>
      caller.callServerEndpoint<List<_i8.AccountApiKey>>(
        'privateApiUsage',
        'getActiveApiKeys',
        {},
      );
  ...
  _i2.Future<_i9.AccountApiUsage> getApiUsageInfo() =>
      caller.callServerEndpoint<_i9.AccountApiUsage>(
        'privateApiUsage',
        'getApiUsageInfo',
        {},
      );

  _i2.Future<_i10.ApiKeyResponse> getApiKeysWithStats() =>
      caller.callServerEndpoint<_i10.ApiKeyResponse>(
        'privateApiUsage',
        'getApiKeysWithStats',
        {},
      );
...
class EndpointPrivateUserScrappables extends _i1.EndpointRef {
  ...
  _i2.Future<_i17.UserPaginatedScrappableResponse> call({
    required int page,
    String? searchQuery,
...
class EndpointCreateScrappable extends _i1.EndpointRef {
  ...
  _i2.Stream<_i12.Scrappable> call({required String referenceLink}) =>
      caller.callStreamingServerEndpoint<_i2.Stream<_i12.Scrappable>,
          _i12.Scrappable>(
        'createScrappable',
        'call',
...
class EndpointMarketplace extends _i1.EndpointRef {
  ...
  _i2.Future<_i19.PaginatedScrappableResponse> getItems({
    required int page,
    String? searchQuery,
    List<_i18.ScraperCategory>? categories,
  }) =>
      caller.callServerEndpoint<_i19.PaginatedScrappableResponse>(
        'marketplace',
        'getItems',
        {
          'page': page,
...
class EndpointPublicScrappable extends _i1.EndpointRef {
  ...
  _i2.Future<_i20.ByteTestData?> getByteTestData(int scrappableId) =>
      caller.callServerEndpoint<_i20.ByteTestData?>(
        'publicScrappable',
        'getByteTestData',
        {'scrappableId': scrappableId},
      );
...
class EndpointScrappableChatSession extends _i1.EndpointRef {
  ...
  _i2.Future<_i22.CreateSessionResponse> createSession(
          {required int scrappableId}) =>
      caller.callServerEndpoint<_i22.CreateSessionResponse>(
        'scrappableChatSession',
        'createSession',
        {'scrappableId': scrappableId},
      );

  _i2.Stream<_i23.ChatResponse> listenToScrappableRedraftSession(
          {required String sessionUuid}) =>
      caller.callStreamingServerEndpoint<_i2.Stream<_i23.ChatResponse>,
          _i23.ChatResponse>(
        'scrappableChatSession',
