...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ApiCreditHistoryState);
}
...
$ApiCreditHistoryStateCopyWith(ApiCreditHistoryState _, $Res Function(ApiCreditHistoryState) __);
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<ApiCreditHistoryItem> creditHistory,  bool hasMore,  bool isLoadingMore)?  loaded,TResult Function( ZenScrapException error)?  withError,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Loaded() when loaded != null:
return loaded(_that.creditHistory,_that.hasMore,_that.isLoadingMore);case _WithError() when withError != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<ApiCreditHistoryItem> creditHistory,  bool hasMore,  bool isLoadingMore)  loaded,required TResult Function( ZenScrapException error)  withError,}) {final _that = this;
switch (_that) {
case _Initial():
return initial();case _Loading():
return loading();case _Loaded():
return loaded(_that.creditHistory,_that.hasMore,_that.isLoadingMore);case _WithError():
return withError(_that.error);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<ApiCreditHistoryItem> creditHistory,  bool hasMore,  bool isLoadingMore)?  loaded,TResult? Function( ZenScrapException error)?  withError,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Loaded() when loaded != null:
...
class _Loaded implements ApiCreditHistoryState {
  const _Loaded({required final  List<ApiCreditHistoryItem> creditHistory, required this.hasMore, this.isLoadingMore = false}): _creditHistory = creditHistory;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Loaded&&const DeepCollectionEquality().equals(other._creditHistory, _creditHistory)&&(identical(other.hasMore, hasMore) || other.hasMore == hasMore)&&(identical(other.isLoadingMore, isLoadingMore) || other.isLoadingMore == isLoadingMore));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_creditHistory),hasMore,isLoadingMore);
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $ApiCreditHistoryStateCopyWith<$Res> {
  factory _$LoadedCopyWith(_Loaded value, $Res Function(_Loaded) _then) = __$LoadedCopyWithImpl;
@useResult
$Res call({
 List<ApiCreditHistoryItem> creditHistory, bool hasMore, bool isLoadingMore
});
...
/// Create a copy of ApiCreditHistoryState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? creditHistory = null,Object? hasMore = null,Object? isLoadingMore = null,}) {
  return _then(_Loaded(
creditHistory: null == creditHistory ? _self._creditHistory : creditHistory // ignore: cast_nullable_to_non_nullable
as List<ApiCreditHistoryItem>,hasMore: null == hasMore ? _self.hasMore : hasMore // ignore: cast_nullable_to_non_nullable
...
/// @nodoc
abstract mixin class _$WithErrorCopyWith<$Res> implements $ApiCreditHistoryStateCopyWith<$Res> {
