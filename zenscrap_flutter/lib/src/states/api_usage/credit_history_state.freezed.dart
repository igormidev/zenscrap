...
class _Initial implements CreditHistoryState {
  ...
  @override
  String toString() {
    return 'CreditHistoryState.initial()';
  }
}
...
class _Loading implements CreditHistoryState {
  ...
  @override
  String toString() {
    return 'CreditHistoryState.loading()';
  }
}
...
class _Loaded implements CreditHistoryState {
  ...
  @override
  String toString() {
    return 'CreditHistoryState.loaded(creditHistory: $creditHistory, hasMore: $hasMore, isLoadingMore: $isLoadingMore)';
  }
}
...
class _WithError implements CreditHistoryState {
  ...
  @override
  String toString() {
    return 'CreditHistoryState.withError(error: $error)';
  }
}
