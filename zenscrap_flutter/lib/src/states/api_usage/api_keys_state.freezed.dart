...
mixin _$ApiKeysState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is ApiKeysState);
  }
...
extension ApiKeysStatePatterns on ApiKeysState {
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(List<AccountApiKey> apiKeys, Map<int, int> usageStats)?
        loaded,
    ...
    switch (_that) {
      ...
      case _Loading() when loading != null:
        return loading();
      case _Loaded() when loaded != null:
        return loaded(_that.apiKeys, _that.usageStats);
      case _WithError() when withError != null:
...
class _Loaded implements ApiKeysState {
  const _Loaded(
      {required final List<AccountApiKey> apiKeys,
      required final Map<int, int> usageStats})
      : _apiKeys = apiKeys,
...
abstract mixin class _$LoadedCopyWith<$Res>
  ...
  @useResult
  $Res call({List<AccountApiKey> apiKeys, Map<int, int> usageStats});
}
