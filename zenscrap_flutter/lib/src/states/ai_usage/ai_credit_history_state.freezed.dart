...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AICreditHistoryState);
}
...
$AICreditHistoryStateCopyWith(AICreditHistoryState _, $Res Function(AICreditHistoryState) __);
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<AICreditHistoryItem> creditHistory,  bool hasMore,  bool isLoadingMore)?  loaded,TResult Function( ZenScrapException error)?  withError,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<AICreditHistoryItem> creditHistory,  bool hasMore,  bool isLoadingMore)  loaded,required TResult Function( ZenScrapException error)  withError,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<AICreditHistoryItem> creditHistory,  bool hasMore,  bool isLoadingMore)?  loaded,TResult? Function( ZenScrapException error)?  withError,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Loaded() when loaded != null:
...
class _Loaded implements AICreditHistoryState {
  const _Loaded({required final  List<AICreditHistoryItem> creditHistory, required this.hasMore, this.isLoadingMore = false}): _creditHistory = creditHistory;
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $AICreditHistoryStateCopyWith<$Res> {
  factory _$LoadedCopyWith(_Loaded value, $Res Function(_Loaded) _then) = __$LoadedCopyWithImpl;
@useResult
$Res call({
 List<AICreditHistoryItem> creditHistory, bool hasMore, bool isLoadingMore
});
...
as List<AICreditHistoryItem>,hasMore: null == hasMore ? _self.hasMore : hasMore // ignore: cast_nullable_to_non_nullable
...
/// @nodoc
abstract mixin class _$WithErrorCopyWith<$Res> implements $AICreditHistoryStateCopyWith<$Res> {
