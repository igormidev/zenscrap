...
void main() async {
  ...
  try {
    ...
    final result = await geminiChat.sendMessage([
      GeminiSdkContent.text('What are the main differences between Dart and JavaScript? Please provide a brief comparison.'),
    ]);
    ...
    final followUp = await geminiChat.sendMessage([
      GeminiSdkContent.text('Which one would you recommend for building mobile apps and why?'),
    ]);
