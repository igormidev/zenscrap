...
void main() async {
  test(
    'Should work with complex prompts AND a response schema',
    () async {
      ...
      final geminiChat = geminiSDK.createNewChat(
          options: GeminiChatOptions(systemPrompt: systemPrompt));

      print('Sending message to Gemini...\n');

      // Send a simple text message
      final result = await geminiChat.sendMessageWithSchema(messages: [
